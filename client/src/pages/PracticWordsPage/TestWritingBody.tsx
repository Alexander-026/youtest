...
import { updateCurrentPairsArrAction, checkCurrentPairsArrAction } from "../../features/generatorWord/generatorWordSlice"
              ...
              {toPractice && (
                <>
                    ...
                    return (
                      ...
                      >
                        {toPractice === "foreign" ? (
                          ...
                          <TextField
                            variant="standard"
                            value={visibility === pair.id ? pair.native : currentPair?.value}
                            onChange={e =>
                              dispatch(
                            ...
                            sx={{ flex: 1 }}
                            size="small"
                            error={validCurrentArrayPairs !== null ? !validCurrentArrayPairs ? currentPair?.value.toLocaleLowerCase() !== pair.native.toLocaleLowerCase() : false: false}
                            InputProps={{
                              endAdornment: (
                                <IconButton
                                  size="small"
                                  onClick={() => visibility === pair.id ? setVisibility(null) : setVisibility(pair.id)}
                                >
                                  {visibility === pair.id ? <MdVisibility /> : <MdVisibilityOff/>} 
                                </IconButton>
                              ),
                            }}
                          />
                        ...
                        {toPractice === "native" ? (
                          ...
                          <TextField
                            variant="standard"
                            value={visibility === pair.id ? pair.foreign : currentPair?.value}
                            error={validCurrentArrayPairs !== null ? !validCurrentArrayPairs ? currentPair?.value.toLocaleLowerCase() !== pair.foreign.toLocaleLowerCase() : false : false}
                            InputProps={{
                              endAdornment: (
                                <IconButton
                                  size="small"
                  ...
                  <Stack
                    ...
                    justifyContent="center"
                  >
                    <Button onClick={() => dispatch(checkCurrentPairsArrAction())} disabled={!!isValid} size="small" variant="contained">
                      <GrLinkNext />
                    </Button>
                  </Stack>
                </>
